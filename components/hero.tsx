      ...
      <div className="grid lg:grid-cols-2 gap-10 items-start">
        ...
        <div>
          ...
          <h1 className="text-3xl lg:text-4xl font-bold text-white leading-tight mb-4 text-balance">
            Creative Graphic Designer & Web Developer
          </h1>
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-2">
              <span className="text-lg font-bold bg-gradient-to-r from-[#06b6d4] to-[#8b5cf6] bg-clip-text text-transparent">5+</span>
              <span className="text-xs text-[#94a3b8]">5+ years<br />Graphic Design Experience</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-lg font-bold bg-gradient-to-r from-[#06b6d4] to-[#8b5cf6] bg-clip-text text-transparent">10+</span>
              <span className="text-xs text-[#94a3b8]">12<br />Projects Completed</span>
            </div>
          </div>
        </div>
          ...
          <div className="w-full max-w-sm rounded-2xl border border-[#1e293b] bg-[#111827] overflow-hidden">
            <div className="h-48 bg-gradient-to-br from-[#06b6d4] via-[#8b5cf6] to-[#06b6d4] flex items-center justify-center">
              <div className="text-center">
                <img src="https://i.ibb.co/0X8237F/Profile- Naim.jpg" alt="Profile Image" className="w-24 h-24 rounded-full mx-auto mb-3" />
                <p className="text-2xl font-bold text-white">Md. Naim Hasan</p>
                <p className="text-sm text-white/80">Bangladesh</p>
                <p className="text-xs text-[#fffff]">Mawlana Bhashani Science and Technology University</p>
              </div>
            </div>
            <div className="p-5 text-center">
              <p className="text-sm font-semibold text-white mb-1">Graphic Designer + Junior Web Developer</p>
              <p className="text-xs text-[#94a3b8] mb-4">Specialized in branding, product visuals, and responsive web UI</p>
